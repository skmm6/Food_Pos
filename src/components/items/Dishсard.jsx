...
export default function Dishсard() {
    ...
    const { id, title, price, sum, image} = food;
    return (
        <div key={id} className=" inline-block min-w-192">
            ...
            <img className=" w-36   transform -translate-y-9" src={('http://localhost:1337')+image.url} alt="image1" />
